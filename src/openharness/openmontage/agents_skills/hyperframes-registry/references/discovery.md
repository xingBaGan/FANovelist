---
name: "hyperframes-registry/references/discovery"
description: "Registry Discovery. The top-level `registry.json` lists all available items:"
when_to_use: "When the agent needs guidance for: registry discovery."
---
