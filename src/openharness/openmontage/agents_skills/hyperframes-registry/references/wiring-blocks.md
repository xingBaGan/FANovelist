---
name: "hyperframes-registry/references/wiring-blocks"
description: "Wiring Blocks. Blocks are standalone compositions with their own `data-composition-id`, dimensions, duration, and GSAP timeline. Include them in a host composition using `data-composition-src` on a `<div>`."
when_to_use: "When the agent needs guidance for: wiring blocks."
---
