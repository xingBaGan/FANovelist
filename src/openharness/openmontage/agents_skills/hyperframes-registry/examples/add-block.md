---
name: "hyperframes-registry/examples/add-block"
description: "Worked Example: Adding a Block. User has an existing HyperFrames project and wants to add an animated chart alongside their video content."
when_to_use: "When the agent needs guidance for: worked example: adding a block."
---
