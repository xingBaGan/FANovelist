---
name: "hyperframes-registry/examples/add-component"
description: "Worked Example: Adding a Component. User wants to add a shimmer light sweep effect to their title text."
when_to_use: "When the agent needs guidance for: worked example: adding a component."
---
