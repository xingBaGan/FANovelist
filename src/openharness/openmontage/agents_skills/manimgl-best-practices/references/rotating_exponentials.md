---
name: "manimgl-best-practices/references/rotating_exponentials"
description: "Rotating Exponentials - Reference Guide. **Example file**: `examples/rotating_exponentials.py`"
when_to_use: "When the agent needs guidance for: rotating exponentials - reference guide."
---
