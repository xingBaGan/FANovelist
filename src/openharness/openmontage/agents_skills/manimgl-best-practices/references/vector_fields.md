---
name: "manimgl-best-practices/references/vector_fields"
description: "Vector Fields - Reference Guide. **Example file**: `examples/vector_fields.py`"
when_to_use: "When the agent needs guidance for: vector fields - reference guide."
---
