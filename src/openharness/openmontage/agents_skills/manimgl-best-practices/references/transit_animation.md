---
name: "manimgl-best-practices/references/transit_animation"
description: "Transit Animations - Reference Guide. **Example file**: `examples/transit_animation.py`"
when_to_use: "When the agent needs guidance for: transit animations - reference guide."
---
