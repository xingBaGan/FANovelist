---
name: "manimgl-best-practices/references/spring_mass_system"
description: "Spring-Mass System - Reference Guide. **Example file**: `examples/spring_mass_system.py`"
when_to_use: "When the agent needs guidance for: spring-mass system - reference guide."
---
