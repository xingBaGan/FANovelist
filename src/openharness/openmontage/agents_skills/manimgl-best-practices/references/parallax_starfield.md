---
name: "manimgl-best-practices/references/parallax_starfield"
description: "Parallax Starfield - Reference Guide. **Example file**: `examples/parallax_starfield.py`"
when_to_use: "When the agent needs guidance for: parallax starfield - reference guide."
---
