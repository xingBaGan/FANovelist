---
name: "manimgl-best-practices/references/equation_transforms"
description: "Equation Transforms - Reference Guide. **Example file**: `examples/equation_transforms.py`"
when_to_use: "When the agent needs guidance for: equation transforms - reference guide."
---
