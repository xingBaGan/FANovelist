---
name: "manimgl-best-practices/rules/camera"
description: "Camera and Frame in ManimGL. ManimGL's camera system is centered around the `CameraFrame`, accessible via `self.camera.frame`. This provides powerful control over both 2D and 3D perspectives."
when_to_use: "When the agent needs guidance for: camera and frame in manimgl."
---
