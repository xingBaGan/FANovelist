---
name: "manimgl-best-practices/rules/animations"
description: "ManimGL Animations. ManimGL's animation system is built around the `Animation` base class. Specialized subclasses handle creation, transformation, and indication effects."
when_to_use: "When the agent needs guidance for: manimgl animations."
---
