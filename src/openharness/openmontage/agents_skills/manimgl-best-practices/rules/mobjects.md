---
name: "manimgl-best-practices/rules/mobjects"
description: "ManimGL Mobjects. ``` Mobject (base class) ├── VMobject (vectorized - most common) │ ├── VGroup │ ├── Circle, Square, Rectangle, Line, Arrow │ ├── Tex, Text, TexText │ └── Axes, NumberPlane ├── Group (non-vectorized container) ├── ImageMobject ├── Point └── 3D objects (Surface, ParametricSur"
when_to_use: "When the agent needs guidance for: manimgl mobjects."
---
