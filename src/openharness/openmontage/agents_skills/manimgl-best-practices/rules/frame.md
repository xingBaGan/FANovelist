---
name: "manimgl-best-practices/rules/frame"
description: "ManimGL Frame (Camera) Control. In ManimGL, camera control is done through `self.camera.frame` (CameraFrame is a Mobject):"
when_to_use: "When the agent needs guidance for: manimgl frame (camera) control."
---
