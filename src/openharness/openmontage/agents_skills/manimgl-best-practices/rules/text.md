---
name: "manimgl-best-practices/rules/text"
description: "Text in ManimGL. ManimGL provides powerful text rendering capabilities through the `Text` and `TexText` classes."
when_to_use: "When the agent needs guidance for: text in manimgl."
---
