---
name: "manimgl-best-practices/rules/tex"
description: "ManimGL LaTeX (Tex Class). **Important:** ManimGL uses `Tex` class (not `MathTex` like ManimCE)."
when_to_use: "When the agent needs guidance for: manimgl latex (tex class)."
---
