---
name: "manimgl-best-practices/rules/cli"
description: "Command Line Interface in ManimGL. ManimGL uses the `manimgl` command for rendering scenes. It offers powerful flags for different workflows."
when_to_use: "When the agent needs guidance for: command line interface in manimgl."
---
