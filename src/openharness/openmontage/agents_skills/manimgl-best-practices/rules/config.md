---
name: "manimgl-best-practices/rules/config"
description: "Configuration in ManimGL. ManimGL uses `custom_config.yml` files for configuration. These files control directories, camera settings, window properties, and more."
when_to_use: "When the agent needs guidance for: configuration in manimgl."
---
