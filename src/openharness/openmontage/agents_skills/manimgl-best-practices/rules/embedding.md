---
name: "manimgl-best-practices/rules/embedding"
description: "Interactive Embedding in ManimGL. ManimGL's `self.embed()` feature drops you into an interactive IPython shell during scene execution, making debugging and experimentation incredibly powerful."
when_to_use: "When the agent needs guidance for: interactive embedding in manimgl."
---
