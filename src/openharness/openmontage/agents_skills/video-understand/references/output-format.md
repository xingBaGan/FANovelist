---
name: "video-understand/references/output-format"
description: "Output Format. The main script (`understand_video.py`) outputs a JSON object to stdout (or to a file with `-o`) containing video metadata, extracted frame paths, and transcription data."
when_to_use: "When the agent needs guidance for: output format."
---
