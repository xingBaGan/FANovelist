---
name: "synthetic-screen-recording/SKILL"
description: "Synthetic Screen Recording (Remotion TerminalScene). **Decision this skill answers:** When the user wants a screen-recording-looking demo of a terminal, CLI tool, or coding workflow — do I **capture the real desktop** (OS screen recording via `screen_recorder`, Windows-MCP, Cap, or Playwright), or d"
when_to_use: "When the agent needs guidance for: synthetic screen recording (remotion terminalscene)."
---
