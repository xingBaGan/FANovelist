---
name: "speech-to-text/references/realtime-client-side"
description: "Client-Side Real-Time Streaming. Stream audio from the browser directly to ElevenLabs for real-time transcription."
when_to_use: "When the agent needs guidance for: client-side real-time streaming."
---
