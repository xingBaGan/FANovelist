---
name: "speech-to-text/references/realtime-events"
description: "Real-Time Event Reference. Complete reference for events in real-time speech-to-text streaming."
when_to_use: "When the agent needs guidance for: real-time event reference."
---
