---
name: "speech-to-text/references/realtime-server-side"
description: "Server-Side Real-Time Streaming. Transcribe audio streams in real-time from your server with ultra-low latency."
when_to_use: "When the agent needs guidance for: server-side real-time streaming."
---
