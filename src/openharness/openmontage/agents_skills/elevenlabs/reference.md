...
description: "ElevenLabs API Reference. Detailed API documentation for ElevenLabs audio generation services."
when_to_use: "When the agent needs guidance for: elevenlabs api reference."
---
