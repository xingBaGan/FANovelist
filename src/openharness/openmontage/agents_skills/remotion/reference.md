...
description: "Remotion API Reference. ```tsx const frame = useCurrentFrame(); ``` Returns current frame (0-indexed). Inside `<Sequence>`, returns relative frame."
when_to_use: "When the agent needs guidance for: remotion api reference."
---
