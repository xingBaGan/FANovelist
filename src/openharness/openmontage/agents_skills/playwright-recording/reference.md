---
name: "playwright-recording/reference"
description: "Playwright Recording Reference. ```typescript interface RecordVideoOptions { dir: string; // Output directory (required) size?: { width: number; height: number }; // Video dimensions }"
when_to_use: "When the agent needs guidance for: playwright recording reference."
---
