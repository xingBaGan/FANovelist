---
name: "visual-style/references/connectors/paper-design"
description: "paper.design Connector. Apply a `visual-style.md` to paper.design documents."
when_to_use: "When the agent needs guidance for: paper.design connector."
---
