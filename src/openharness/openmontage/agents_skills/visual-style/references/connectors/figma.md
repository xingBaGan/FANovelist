---
name: "visual-style/references/connectors/figma"
description: "Figma Connector. Apply a `visual-style.md` to generate Figma styles and components."
when_to_use: "When the agent needs guidance for: figma connector."
---
