---
name: "visual-style/references/connectors/html-slides"
description: "HTML Slides Connector (frontend-slides). Apply a `visual-style.md` to HTML slide presentations."
when_to_use: "When the agent needs guidance for: html slides connector (frontend-slides)."
---
