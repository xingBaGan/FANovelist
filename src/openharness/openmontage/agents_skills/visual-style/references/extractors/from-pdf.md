---
name: "visual-style/references/extractors/from-pdf"
description: "Extract from PDF / Brand Guide. Generate a `visual-style.md` from a PDF brand guide or style document."
when_to_use: "When the agent needs guidance for: extract from pdf / brand guide."
---
