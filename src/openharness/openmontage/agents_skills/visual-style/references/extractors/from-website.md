---
name: "visual-style/references/extractors/from-website"
description: "Extract from Website. Generate a `visual-style.md` from a website URL."
when_to_use: "When the agent needs guidance for: extract from website."
---
