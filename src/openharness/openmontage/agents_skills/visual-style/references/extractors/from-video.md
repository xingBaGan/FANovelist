---
name: "visual-style/references/extractors/from-video"
description: "Extract from Video. Generate a `visual-style.md` from video keyframes."
when_to_use: "When the agent needs guidance for: extract from video."
---
