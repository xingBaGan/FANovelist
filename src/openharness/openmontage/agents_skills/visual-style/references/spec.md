---
name: "visual-style/references/spec"
description: "visual-style.md Format Specification. **Version:** 1.0 **Status:** Draft"
when_to_use: "When the agent needs guidance for: visual-style.md format specification."
---
