---
name: "d3-viz/references/scale-reference"
description: "D3.js Scale Reference. Comprehensive guide to all d3 scale types with examples and use cases."
when_to_use: "When the agent needs guidance for: d3.js scale reference."
---
