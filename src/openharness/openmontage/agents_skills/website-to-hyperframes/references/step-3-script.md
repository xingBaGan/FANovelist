---
name: "website-to-hyperframes/references/step-3-script"
description: "Step 3: Write the Narration Script. **Before writing, re-read DESIGN.md** — specifically the Overview and Components sections. The script should reference real product features, real stats, and real components that the website highlights. Use exact numbers from `extracted/visible-text.txt`."
when_to_use: "When the agent needs guidance for: step 3: write the narration script."
---
