---
name: "website-to-hyperframes/references/step-1-capture"
description: "Step 1: Capture & Understand. ```bash npx hyperframes capture <URL> -o captures/<project-name> ```"
when_to_use: "When the agent needs guidance for: step 1: capture & understand."
---
