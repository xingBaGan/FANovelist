---
name: "website-to-hyperframes/references/step-2-design"
description: "Step 2: Write DESIGN.md. DESIGN.md is a **brand cheat sheet** for the captured website. It encodes the visual identity so you can reference exact colors, fonts, and patterns while writing the storyboard and compositions."
when_to_use: "When the agent needs guidance for: step 2: write design.md."
---
