---
name: "manim-composer/references/scene-examples"
description: "Scene Examples. Example scene breakdowns from 3b1b-style videos."
when_to_use: "When the agent needs guidance for: scene examples."
---
