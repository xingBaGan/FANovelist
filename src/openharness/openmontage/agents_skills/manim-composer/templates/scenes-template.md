---
name: "manim-composer/templates/scenes-template"
description: "[Video Title]. - **Topic**: [Core mathematical/scientific concept] - **Hook**: [Opening question or mystery that draws viewers in] - **Target Audience**: [Prerequisites - what math/science background is assumed] - **Estimated Length**: [X minutes] - **Key Insight**: [The central \"aha moment\" - the o"
when_to_use: "When the agent needs guidance for: [video title]."
---
