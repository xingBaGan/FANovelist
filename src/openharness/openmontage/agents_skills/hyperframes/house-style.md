---
name: "hyperframes/house-style"
description: "House Style. Creative direction for compositions when no `visual-style.md` is provided. These are starting points — override anything that doesn't serve the content."
when_to_use: "When the agent needs guidance for: house style."
---
