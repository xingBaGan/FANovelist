---
name: "hyperframes/references/transitions/catalog"
description: "Transition Catalog. Hard rules, scene template, and routing to implementation code. Read the reference file for the transition type you need — don't load all of them."
when_to_use: "When the agent needs guidance for: transition catalog."
---
