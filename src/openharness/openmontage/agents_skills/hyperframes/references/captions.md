---
name: "hyperframes/references/captions"
description: "Captions. **Never use `.en` models unless the user explicitly states the audio is English.** `.en` models TRANSLATE non-English audio into English instead of transcribing it."
when_to_use: "When the agent needs guidance for: captions."
---
