---
name: "hyperframes/references/dynamic-techniques"
description: "Dynamic Caption Techniques. You are here because SKILL.md told you to read this file before writing animation code. Pick your technique combination from the table below based on the energy level you detected from the transcript, then implement using standard GSAP patterns."
when_to_use: "When the agent needs guidance for: dynamic caption techniques."
---
