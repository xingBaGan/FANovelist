---
name: "hyperframes/references/tts"
description: "Text-to-Speech. Generate speech audio locally using Kokoro-82M (no API key, runs on CPU)."
when_to_use: "When the agent needs guidance for: text-to-speech."
---
