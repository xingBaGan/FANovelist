---
name: "hyperframes/references/typography"
description: "Typography. The compiler embeds supported fonts — just write `font-family` in CSS."
when_to_use: "When the agent needs guidance for: typography."
---
