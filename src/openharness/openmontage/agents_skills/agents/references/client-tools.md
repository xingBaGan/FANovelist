---
name: "agents/references/client-tools"
description: "Client Tools. Extend your agent with custom capabilities. Tools let the agent take actions beyond just talking."
when_to_use: "When the agent needs guidance for: client tools."
---
