---
name: "agents/references/outbound-calls"
description: "Outbound Calls. Make outbound phone calls using your ElevenLabs agent via Twilio integration."
when_to_use: "When the agent needs guidance for: outbound calls."
---
