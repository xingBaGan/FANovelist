---
name: "agents/references/agent-configuration"
description: "Agent Configuration. Complete reference for configuring conversational AI agents."
when_to_use: "When the agent needs guidance for: agent configuration."
---
