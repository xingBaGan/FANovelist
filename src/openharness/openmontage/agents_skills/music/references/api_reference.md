---
name: "music/references/api_reference"
description: "Music API Reference. - [compose](#compose) - [composition_plan.create](#composition_plancreate) - [compose_detailed](#compose_detailed) - [upload](#upload) - [Error Handling](#error-handling)"
when_to_use: "When the agent needs guidance for: music api reference."
---
