...
# Character to NarrativeElement (items, skills) relations
for _c in _CHAR_LABELS:
...
1. 优先使用已定义的标准关系类型：
   ...
   - 行为动作：KILLED, SAVED, HELPED, ATTACKED, DEFEATED, BETRAYED, GAVE_ITEM_TO, STOLE_FROM, STUDIED, LEARNED, PARTICIPATED_IN, INVOLVED_IN, WITNESSED
