...
def comparison_outputs(tmp_path_factory):
    ...
    from openharness.openmontage.tools.enhancement.face_enhance import FaceEnhance
    from openharness.openmontage.tools.enhancement.color_grade import ColorGrade
    from openharness.openmontage.tools.audio.audio_enhance import AudioEnhance
