...
5. Ask the human to review the generated summary buffer file at `studio/whitepaper.summary.md`. Once the human approves, ingest the approved summaries into the canon graph:
...
6. Write marker file `studio/.approved-whitepaper` with ISO date.
7. Reply: Phase 2 unlocked. Use `/novel-studio:chapter 1` to start chapter pipeline.
